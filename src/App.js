    ...
    <div className="relative bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20  lg:w-full lg:pb-28 xl:pb-32">
          ...
          {finished ? (
            <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl my-6">
              You correctly guessed {answer} with {revealedActors} actors
              revealed
            </h3>
          ) : (
            <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl my-6">
              Clue: {answer.replace(/\S/g, "#")}
            </h3>
          )}
          <form onSubmit={handleSubmit}>
            ...
            <input
              type="submit"
              value="Submit"
              className="mt-3 w-full bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            />
          </form>
